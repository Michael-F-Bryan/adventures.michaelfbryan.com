...
- When you review newbie code and 99% of things you’ll tell them would’ve been suggested by `clippy` as well.

## Manual Argument Parsing

- w.r.t. CLI, parsing arguments manually, or even trying to configure `clap` manually, instead of using `structopt` to create a strongly-typed input/config struct.
